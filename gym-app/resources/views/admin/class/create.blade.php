        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('gymClass.store')}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="row mb-4">
                            <label for="name" class="col-md-3 form-label">Class Name</label>
                            <div class="col-md-9">
                                <input class="form-control" id="name" value="{{old('name')}}" name="name" placeholder="Class Name" type="text"/>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="capacity" value="{{old('capacity')}}" name="capacity" placeholder="Class Member Capacity" type="number" required/>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="class_time" value="{{old('class_time')}}" name="class_time" placeholder="Class Duration in Minutes" type="datetime-local" required/>
                            </div>
